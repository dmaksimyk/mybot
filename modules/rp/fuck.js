...
module.exports = async (msg) => {
  ...
  if (data.tag === user[0].first_name) return msg.send(`${ment}, вы трахнули [id${replyUser[0].id}|${replyUser[0].first_name}]!`);
  return msg.send(`${ment}, вы трахнули ${(data.mentioning === true) ? `[id${data.vk_id}|${data.tag}]` : `${data.tag}` }!`);
};
